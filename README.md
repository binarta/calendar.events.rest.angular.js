# calendar.events.rest.angular.js

[AngularJS](http://angularjs.org/) module for calendar events persisted in rest backend based on the [Binarta](http://binarta.com/) platform.
